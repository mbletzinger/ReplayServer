...
public class AnnotatedBlockModule extends AbstractModule {

	private final String blockName;

	public AnnotatedBlockModule(String blockName) {
		super();
	...
	protected void configure() {
		bind(BlockI.class).toInstance(new SimpleBlock("Default"));
